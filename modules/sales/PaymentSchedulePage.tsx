              ...
              <tbody className="divide-y divide-border-default">
                {displayed.map(i => (
                  <tr key={i.id} className="hover:bg-surface-muted">
                    ...
                    <td className="px-4 py-3 font-semibold text-content">{fmt(i.amount)}</td>
                    ...
                    <td className="px-4 py-3">
                      {i.invoiceId ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-lg border border-blue-300 text-primary hover:bg-primary/10 disabled:opacity-50 font-medium"
                        >
